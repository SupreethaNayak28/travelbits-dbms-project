...
<div class="image-container">
  <img src="assets/img/gol.jpg" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Description</h2>
...
<a href="https://en.wikipedia.org/wiki/Gol_Gumbaz" class="btn">Read More!</a>  
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Gol Gumbaz,Karnataka India"; // Set the default address
