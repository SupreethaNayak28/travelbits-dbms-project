...
<div class="image-container">
  <img src="assets/img/hampi1.webp" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Description</h2>
    <p>Hampi or Hampe (Kannada: [hɐmpe]), also referred to as the Group of Monuments at Hampi, is a UNESCO World Heritage Site located in Vijayanagara district.Hampi continues as a religious centre, with the Virupaksha Temple, an active Adi Shankara-linked monastery and various monuments belonging to the old city.</p>
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Hampi,Karnataka India"; // Set the default address
