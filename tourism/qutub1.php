...
<div class="image-container">
  <img src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Qutub_Minar_in_the_monsoons.jpg" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Description</h2>
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Qutb Minar, New Delhi, India"; // Set the default address
