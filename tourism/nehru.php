...
<div class="image-container">
  <img src="assets/img/nehru.jpg" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Nehru Planetarium</h2>
    <p>Nehru Planetariums are the five planetariums in India, named after India's first Prime Minister, Jawaharlal Nehru. These are located in Mumbai, New Delhi, Pune and Bangalore, plus there is a Jawahar Planetarium in Allahabad, where Nehru was born.</p>

<a href="https://en.wikipedia.org/wiki/Nehru_Planetarium" class="btn">Read More!</a>  
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Nehru Planetarium, Mumbai, India"; // Set the default address
