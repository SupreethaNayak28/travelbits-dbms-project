...
<div class="image-container">
  <img src="assets/img/karnataka.jpg" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Description</h2>
...
<a href="https://en.wikipedia.org/wiki/Mysore_Palace" class="btn">Read More!</a>  
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Mysuru Palace, Karnataka, India"; // Set the default address
