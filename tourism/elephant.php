...
<div class="image-container">
  <img src="assets/img/elephant1.jpg" width="560px" class="img-fluid" alt="...">
  <div class="text-box">
    <h2>Description</h2>
    <p>The Elephanta Caves are a collection of cave temples predominantly dedicated to the Hindu god Shiva, which have been designated a UNESCO World Heritage Site.The island, about 2 kilometres west of the Jawaharlal Nehru Port, consists of five Hindu caves, a few Buddhist stupa mounds that date back 2nd century BCE.</p>

<a href="https://en.wikipedia.org/wiki/Elephanta_Caves" class="btn">Read More!</a>  
...
<div class="col-md-4 py-3 py-md-0 mx-auto mt-4">
    <div class="card">
        <div class="map-container">
            <?php
            $defaultAddress = "Elephanta Caves,Mumbai,India"; // Set the default address
